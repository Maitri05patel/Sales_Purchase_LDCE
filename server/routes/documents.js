...
router.get('/', (req, res) => {
  res.json({
    ...
    catalog: [
      ...
      { docId: 'DOC-23', name: 'Bid Scrutiny Report (Evaluation Matrix)', phase: 5, entityParam: 'entityId = bid_id' },
      { docId: 'DOC-24', name: 'Reasons for Disqualification Sheet', phase: 5, entityParam: 'entityId = bid_id' },
      { docId: 'DOC-25', name: 'DLPC Agenda & Proposal (3-Page Checklist Format)', phase: 5, entityParam: 'entityId = meeting_id' },
      { docId: 'DOC-25A', name: 'GeM Agenda Format – DLPC', phase: 5, entityParam: 'entityId = meeting_id' },
      { docId: 'DOC-26', name: 'Certificate for reasonability of rate', phase: 5, entityParam: 'entityId = meeting_id' },
